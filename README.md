...
This app requires a `FRED_API_KEY` environment variable before running `live_app.py`.

- Windows PowerShell: `$env:FRED_API_KEY="your_fred_api_key_here"; python live_app.py`
- macOS/Linux: `export FRED_API_KEY=your_fred_api_key_here && python live_app.py`
- Example variable name: `.env.example`

> If `FRED_API_KEY` is not set, the app will raise a clear error explaining how to set it.
